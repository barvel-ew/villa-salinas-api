...
const INICIAL_DEFECTO = 10000;
const INICIAL_MINIMA = 5000;
...
module.exports = async function handler(req, res) {
  ...
  const { lote, pago = 'contado', inicial = INICIAL_DEFECTO, meses = MESES_DEFECTO } = req.query;
  ...
  const inicialNum = Math.max(INICIAL_MINIMA, Number(inicial) || INICIAL_DEFECTO);
